 ...
 * of {@link webhook.WebhookClient} send methods.
 *
...
public class ReadonlyMessage implements JSONString {
     ...
     * <br>You can use {@link webhook.MessageFlags} to determine which flags are set.
     *
     * @return The flags
     */
    public int getFlags() {
    ...
    /**
     * The author of this message, represented by a {@link webhook.receive.ReadonlyUser} instance.
     *
     * @return The author
     */
    @NotNull
     ...
     * added through methods such as {@link webhook.send.WebhookMessageBuilder#addFile(java.io.File)}.
     ...
     *
     * @return {@link webhook.send.WebhookMessage}
     */
    @NotNull
