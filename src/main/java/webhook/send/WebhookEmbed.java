...
/**
 * Reduced version of an {@link webhook.receive.ReadonlyEmbed}
 * used for sending. A webhook can send up to {@value WebhookMessage#MAX_EMBEDS} embeds
 * in a single message.
 *
 * @see webhook.send.WebhookEmbedBuilder
 */
public class WebhookEmbed implements JSONString {
     ...
     *
     * @return Possibly-null {@link webhook.send.WebhookEmbed.EmbedTitle}
     */
    @Nullable
    @JSONPropertyIgnore
     ...
     *
     * @return Possibly-null {@link webhook.send.WebhookEmbed.EmbedFooter}
     */
    @Nullable
     ...
     *
     * @return Possibly-null {@link webhook.send.WebhookEmbed.EmbedAuthor}
     */
    @Nullable
    ...
    public static class EmbedField implements JSONString {
         ...
         *
         * @see webhook.send.WebhookEmbedBuilder#addField(webhook.send.WebhookEmbed.EmbedField)
         */
    ...
    public static class EmbedAuthor implements JSONString {
         ...
         *
         * @see webhook.send.WebhookEmbedBuilder#setAuthor(webhook.send.WebhookEmbed.EmbedAuthor)
         */
    ...
    public static class EmbedFooter implements JSONString {
         ...
         *
         * @see   webhook.send.WebhookEmbedBuilder#setFooter(webhook.send.WebhookEmbed.EmbedFooter)
         */
    ...
    public static class EmbedTitle {
         ...
         *
         * @see   webhook.send.WebhookEmbedBuilder#setTitle(webhook.send.WebhookEmbed.EmbedTitle)
         */
