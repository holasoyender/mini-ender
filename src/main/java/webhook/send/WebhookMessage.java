...
/**
 * Send-only message for a {@link webhook.WebhookClient}
 * <br>A {@link webhook.receive.ReadonlyMessage} can be sent
 * by first converting it to a WebhookMessage with {@link #from(webhook.receive.ReadonlyMessage)}.
 */
public class WebhookMessage {
    ...
    /**
     * Converts a {@link webhook.receive.ReadonlyMessage} to a
     * WebhookMessage.
