...
public class WebhookCluster implements AutoCloseable { //TODO: tests
     ...
     * {@link webhook.WebhookClient} instances.
     *
     ...
     *
     * @see    webhook.WebhookClientBuilder#setHttpClient(okhttp3.OkHttpClient)
     */
    @NotNull
     ...
     * @return WebhookCluster instance for chaining convenience
     *
     * @see    webhook.WebhookClientBuilder#setExecutorService(java.util.concurrent.ScheduledExecutorService)
     */
    @NotNull
     ...
     * @return WebhookCluster instance for chaining convenience
     *
     * @see    webhook.WebhookClientBuilder#setThreadFactory(java.util.concurrent.ThreadFactory)
     */
    @NotNull
    ...
    /**
     * Configures whether {@link webhook.WebhookClient} instances should be daemon by default.
     *
     * @param  isDaemon
     ...
     * @return WebhookCluster instance for chaining convenience
     *
     * @see    webhook.WebhookClientBuilder#setDaemon(boolean)
     */
    @NotNull
    ...
    /**
     * Builds a {@link webhook.WebhookClient} instance with the provided
    ...
    /**
     * Creates a {@link webhook.WebhookClientBuilder} instance with the provided
     * components and specified default configurations.
